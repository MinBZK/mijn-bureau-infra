...
| `host`                                              | Nextcloud host to create application URLs. This is added to `trusted_domains` at install only                                                                                                                               | `nextcloud.kube.home`            |
...
| `externalDatabase.type`                             | Set to 'mysql' or 'postgres'                                                                                                                                                                                                | `""`                             |
...
| `containerPorts.http`                               | Nextcloud HTTP container port                                                                                                                                                                                               | `80`                             |
| `containerPorts.https`                              | Nextcloud HTTPS container port                                                                                                                                                                                              | `443`                            |
| `extraContainerPorts`                               | Optionally specify extra list of additional ports for Nextcloud containers                                                                                                                                                  | `[]`                             |
| `livenessProbe.enabled`                             | Enable livenessProbe on Nextcloud containers                                                                                                                                                                                | `true`                           |
| `livenessProbe.initialDelaySeconds`                 | Initial delay seconds for livenessProbe                                                                                                                                                                                     | `10`                             |
| `livenessProbe.periodSeconds`                       | Period seconds for livenessProbe                                                                                                                                                                                            | `10`                             |
| `livenessProbe.timeoutSeconds`                      | Timeout seconds for livenessProbe                                                                                                                                                                                           | `5`                              |
| `livenessProbe.failureThreshold`                    | Failure threshold for livenessProbe                                                                                                                                                                                         | `3`                              |
| `livenessProbe.successThreshold`                    | Success threshold for livenessProbe                                                                                                                                                                                         | `1`                              |
| `readinessProbe.enabled`                            | Enable readinessProbe on Nextcloud containers                                                                                                                                                                               | `true`                           |
...
| `updateStrategy.type`                               | Nextcloud deployment strategy type                                                                                                                                                                                          | `RollingUpdate`                  |
| `updateStrategy.type`                               | Nextcloud statefulset strategy type                                                                                                                                                                                         | `RollingUpdate`                  |
| `podManagementPolicy`                               | Pod management policy for Nextcloud statefulset                                                                                                                                                                             | `OrderedReady`                   |
...
| Name                                    | Description                                                                                                                      | Value                    |
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| `service.type`                          | Nextcloud service type                                                                                                           | `LoadBalancer`           |
| `service.ports.http`                    | Nextcloud service HTTP port                                                                                                      | `80`                     |
| `service.ports.https`                   | Nextcloud service HTTPS port                                                                                                     | `443`                    |
