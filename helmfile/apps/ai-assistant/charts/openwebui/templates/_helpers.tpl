...
{{- include "common.images.renderPullSecrets" (dict "images" (list .Values.image .Values.%%SECONDARY_OBJECT_BLOCK%%.image .Values.defaultInitContainers.volumePermissions.image) "context" $) -}}
{{- end -}}
