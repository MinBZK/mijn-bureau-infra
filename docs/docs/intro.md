...
| Notes              | Docs                 | [v3.9.0](https://github.com/suitenumerique/docs/releases/tag/v3.9.0)              | [documentation](https://github.com/suitenumerique/docs/tree/main/docs/installation)  | MIT        |
