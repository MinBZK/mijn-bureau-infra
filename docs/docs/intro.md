...
| Notes              | Docs                 | [v4.8.5](https://github.com/suitenumerique/docs/releases/tag/v4.8.5)                | [documentation](https://github.com/suitenumerique/docs/tree/main/docs/installation)  | MIT        |
