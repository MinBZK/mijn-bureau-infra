...
| Chat               | Element Synapse      | [v1.144.0](https://github.com/element-hq/element-web/tree/vv1.144.0)                     | [documentation](https://element-hq.github.io/synapse/latest/)                        | AGPL-3.0   |
| Chat UI            | Element Web          | [v1.12.6](https://github.com/element-hq/element-web/tree/vv1.144.0)                   | [documentation](https://element.io/)                                                 | AGPL-3.0   |
...
| Notes              | Docs                 | [v3.10.0](https://github.com/suitenumerique/docs/releases/tag/v3.10.0)              | [documentation](https://github.com/suitenumerique/docs/tree/main/docs/installation)  | MIT        |
