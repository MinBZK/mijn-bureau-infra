...
| AI LLM             | Ollama               | [v0.23.2](https://github.com/ollama/ollama/tree/v0.23.2)                            | [documentation](https://ollama.com/)                                                 | MIT        |
| File sharing       | Nextcloud            | [v33.0.3](https://github.com/nextcloud/server/tree/v33.0.3)                         | [documentation](https://nextcloud.com/)                                              | AGPL-3.0   |
| Spreadsheet        | Grist                | [v1.7.13](https://github.com/gristlabs/grist-core/tree/v1.7.13)                     | [documentation](https://support.getgrist.com/self-managed/)                          | Apache-2.0 |
...
| Notes              | Docs                 | [v5.0.0](https://github.com/suitenumerique/docs/releases/tag/v5.0.0)                | [documentation](https://github.com/suitenumerique/docs/tree/main/docs/installation)  | MIT        |
